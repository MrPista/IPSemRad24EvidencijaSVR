		...
		if (isset($_GET['filtriraj']))
			{
				...
				$filter=$_GET['filter'];
				$VojniKandidatViewObject->DajSvePodatkeOVojnimKandidatima($filter);
			...
			else
			{
				...
				$VojniKandidatViewObject->DajSvePodatkeOVojnimKandidatima($filter);
				// sada raspolazemo sa:
				$VojniKandidatViewObject->Kolekcija;
				$VojniKandidatViewObject->BrojZapisa;
			}
...
<?php include 'delovi/desnoVojniKandidatLista.php';?>
</td>
