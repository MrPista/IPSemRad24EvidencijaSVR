...
if ($VojniKandidatViewObject->BrojZapisa==0)
	...
	echo "УКУПАН БРОЈ ЗАПИСА:".$VojniKandidatViewObject->BrojZapisa;
		...
		$IDKandidata=$VojniKandidatViewObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($VojniKandidatViewObject->Kolekcija, $RBZapisa, 0);//mysql_result($result,$RBZapisa,"REGISTARSKIBROJ");
