...
<td align="left">
<br/>
<b><font face="Trebuchet MS" color="cbe3f7" size="4px">  </font></b>
...
<td align="center">
<b><font face="Trebuchet MS" color="black" size="3px">УНОС НОВОГ КАНДИДАТА</b></br>
</td>
<td style="width:3%;">
</td>
</tr>
...
<form name="FormaZaUnosVojnogKandidata" action="VojniKandidatSnimi.php" METHOD="POST" enctype="multipart/form-data" >
...
<td align="left" valign="bottom">
<input name="datumRodjenja" type="text" size="50" placeholder="Унесите датум рођења (гггг-мм-дд)" pattern="\d{4}-\d{2}-\d{2}" title="Унесите датум рођења у траженој форми" required/>
</td>
</tr>
