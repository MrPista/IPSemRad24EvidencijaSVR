...
<table style="width:100%;" width:100%; padding:0" align="center" cellspacing="0" cellpadding="0" border="0" bgcolor="#D8E7F4">
	...
	<tr>
		...
		<td>
			<font face="Trebuchet MS" color="darkblue" size="4px">
				<b>СПИСАК ВОЈНИХ КАНДИДАТА</br>
			</font>
			<form action="" method="GET">
				ИД КАНДИДАТА: <input type="text" name="filter" />
		...
		<td align="left">
			...
			<font face="Trebuchet MS" color="darkblue" size="4px">
				...
				if ($VojniKandidatViewObject->BrojZapisa == 0) {
					...
					echo "</td>";
					echo "<td style=\"width:10%;\">";
					echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"3px\">ИМЕ КАНДИДАТА</font><br/>";
					echo "</td>";
					echo "<td style=\"width:20%;\">";
					echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"3px\">ПРЕЗИМЕ КАНДИДАТА</font><br/>";
					echo "</td>";
					echo "<td style=\"width:20%;\">";
					...
					for ($RBZapisa = 0; $RBZapisa < $VojniKandidatViewObject->BrojZapisa; $RBZapisa++) {
						...
						echo "</td>";
						echo "<td>";
						echo "<form ACTION=\"VojniKandidatIzmeniForm.php\" METHOD=\"POST\">";
						echo "<input type=\"hidden\" name=\"IDKandidata\" value=\"$IDKandidata\">";
						echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\"><input TYPE=\"submit\" name=\"izmeniVojnogKandidata\" value=\"IZMENI\" /></font></b>";
						echo "</form>";
						echo "</td>";
						if (isset($korisnik) && $status === 'admin') {
							echo "<td>";
							echo "<form ACTION=\"VojniKandidatObrisi.php\" METHOD=\"POST\">";
							echo "<input type=\"hidden\" name=\"IDKandidata\" value=\"$IDKandidata\">";
							echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\"><input TYPE=\"submit\" name=\"obrisiVojnogKandidata\" value=\"OBRISI\"  onclick=\"return confirm('Da li ste sigurni da zelite da obrisete zapis?')\"/></font></b>";
							echo "</form>";
							echo "</td>";
						}
						echo "</tr>";
